...
module.exports = (connection, verbose) => {
	...
	connection.query(
	    `SELECT Website.WebsiteID, Size, Count, Structure, 
             ...
             WHERE (ResponseContentLength IS NOT NULL) AND (Structure = "d") 
             GROUP BY WebsiteID;`,
		...
		HTML += "var options = {"+
		    "title:'Load time over different number of files of random size',"+
		...
		fs.writeFileSync('./charts/num_files_by_random.html', HTML);
