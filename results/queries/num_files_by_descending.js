...
module.exports = (connection, verbose) => {
	...
	connection.query(
	    `SELECT Website.WebsiteID, Size, Count, Structure, 
             ...
             WHERE (ResponseContentLength IS NOT NULL) AND (Structure = "c") 
             GROUP BY WebsiteID;`,
		...
		HTML += "var options = {"+
		    "title:'Load time over different number of files in descending order',"+
		...
		fs.writeFileSync('./charts/num_files_by_descending.html', HTML);
